...
meta2 <- read.csv("/Users/Yajas/Documents/Elemento/AgeTCGA-master/DATA/GTEx/GTEx_Analysis_v8_Annotations_SubjectPhenotypesDS.txt",
                  stringsAsFactors = F, header = T, sep = "\t")
gtex_data <- read.table("/Users/Yajas/Documents/Elemento/AgeTCGA-master/DATA/GTEx/Tissues/GTEx_Thyroid.txt")
...
#tiff("./Final/Figures/cancer_vs_normal_pathways.tiff", width = 12, height = 6, units = "in", res = 320)
pheatmap(mat = df,border_color = NA, color = pal_gsea("default")(12), cellheight = 20, cellwidth = 20,
         annotation_col = column_anno, annotation_names_col = F,  fontsize = 20, 
         treeheight_row = 20, treeheight_col = 20, legend = F, cutree_cols = 2, 
