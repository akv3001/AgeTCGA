...
survival_data <- survival_data[survival_data$Quartiles %in% c(1,4), ]
survival_data$Quartiles <- ifelse(survival_data$Quartiles == 1, "Young", "Old")
folder <- "/Users/Yajas/Downloads/methylation_gene_beta/"
...
tiff(filename = "/Users/Yajas/Documents/Elemento/AgeTCGA-master/Final/Figures/Figure 1/commonRNA_down.tiff",
     res = 320, height = 6, width = 6, units = "in")
corrplot(or_data_down, is.corr = F, method = "color", p.mat = pval_data_down, insig = "label_sig",
         sig.level = c(.001, .01, .05), pch.cex = 2, pch.col = "white", tl.col = "black", type = "upper",
         tl.cex = 2, outline = "white", col = brewer.pal(9, "Blues"))
dev.off()
tiff(filename = "/Users/Yajas/Documents/Elemento/AgeTCGA-master/Final/Figures/Figure 1/commonRNA_up.tiff",
     res = 320, height = 6, width = 6, units = "in")
corrplot(or_data_up, is.corr = F, method = "color", p.mat = pval_data_up, insig = "label_sig",
         sig.level = c(.001, .01, .05), pch.cex = 2, pch.col = "white", tl.col = "black", type = "upper",
         tl.cex = 2, outline = "white", col = brewer.pal(9, "Reds"))
dev.off()
...
tiff(filename = "/Users/Yajas/Documents/Elemento/AgeTCGA-master/Final/Figures/Figure 1/commonMeth_down.tiff",
     res = 320, height = 6, width = 6, units = "in")
corrplot(or_data_down, is.corr = F, method = "color", p.mat = pval_data_down, insig = "label_sig",
         sig.level = c(.001, .01, .05), pch.cex = 2, pch.col = "white", tl.col = "black", 
         tl.cex = 2, outline = "white", col = brewer.pal(9, "Blues"))
dev.off()
tiff(filename = "/Users/Yajas/Documents/Elemento/AgeTCGA-master/Final/Figures/Figure 1/commonMeth_up.tiff",
     res = 320, height = 6, width = 6, units = "in")
corrplot(or_data_up, is.corr = F, method = "color", p.mat = pval_data_up, insig = "label_sig",
         sig.level = c(.001, .01, .05), pch.cex = 2, pch.col = "white", tl.col = "black", 
         tl.cex = 2, outline = "white", col = brewer.pal(9, "Reds"))
...
ggsave("/Users/Yajas/Downloads/differential_meth_gene_level.jpg", dpi = 320)
