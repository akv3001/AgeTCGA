...
PATH <- "/Users/Yajas/Documents/Elemento/AgeTCGA-master/DATA/HG 19 Meth/Horvath/Output/"
...
write.table(x = combined_data, file = paste0(PATH, "Combined Output/DNAm_Age.txt"))
write.table(x = dat0, file = paste0(PATH, "Combined Output/DNAm_Age and Quartile Info.txt"))
...
dat0 <- dat0[dat0$type %in% c("BRCA","COAD","LGG","SARC","THCA","UCEC"), ]
...
ggsave("./Final/Figures/Figure 4/Epigenetic_Age.jpg", dpi = 320, height = 9, width = 9)



# Remove Q2-Q3 samples
#dat0 <- dat0[dat0$Quartiles != "Q2-Q3", ]
...
ggsave("./Final/Figures/Figure 4/Quartile_Age_Acceleration1.jpg", dpi = 320)
...
ggsave("./Final/Figures/Figure 4/Normal_Quartiles1.jpg", dpi = 320)
